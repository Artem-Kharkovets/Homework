...
#  s2=  The program replaces all occurrences of the letter 'h' in
#       the text you enter with the letter 'H', except for the first and
#       last occurrences. You can also choose any other letter of
#       the alphabet. The program will replace lowercase letters with
#       uppercase ones. Text can be entered with all grammatical characters.
#  s3= -введите текст
#  s3=  enter text
...
#  s6=  You cannot enter numbers in the program. Try again!
